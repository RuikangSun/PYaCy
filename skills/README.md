...
| [pyacy-crawler](pyacy-crawler/SKILL.md) | HTTP+本地 | 网页抓取与本地索引管理 |
| [pyacy-status](pyacy-status/SKILL.md) | HTTP+P2P | 节点状态与网络信息查询 |
...
| v0.4.1 | pyacy-search 新增高级搜索语法说明；pyacy-rwi 修复 DHT 哈希路由 + 参数优化；pyacy-bootstrap 更新种子探测参数 |
